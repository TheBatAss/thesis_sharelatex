...
The work of Ponnada et al., Kami\'nski and Dam-Jensen all point towards the benefit reducing the burdens. Their work has been a great inspiration for this thesis, together with Larsen et al. work showing the real world benefit of in situ measurements. This thesis will further investigate two of Dam-Jensen's designs, the \say{Rotate Lower Arm} and \say{Rotate Upper Arm Around Elbow} methods, developing these methods a bit further and then comparing them to a VAS by a \say{rating of blackness} experiment. And the authors previous work has shown that even a well designed smartphone app still creates a lot of burden for the user when comparing it to the more novel designs of Dam-Jensen.